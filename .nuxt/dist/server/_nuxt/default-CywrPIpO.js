...
import "klona";
import "devalue";
const _imports_0 = "" + __buildAssetsURL("logo.uLL_3cUE.png");
const _sfc_main$2 = {};
...
function _sfc_ssrRender$1(_ctx, _push, _parent, _attrs) {
  _push(`<footer${ssrRenderAttrs(_attrs)}><div class="bg-[#F3F3F3] container-fluid"><p class="text-center">Copyright © 2024</p></div></footer>`);
}
...
//# sourceMappingURL=default-CywrPIpO.js.map
