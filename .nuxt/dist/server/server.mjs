...
const _routes = [
  {
    ...
    component: () => import("./_nuxt/about-tBmn0pHg.js").then((m) => m.default || m)
  },
  {
    name: "index",
    path: "/",
    ...
    component: () => import("./_nuxt/index-DGPlgmHI.js").then((m) => m.default || m)
  },
  {
    name: "products-id",
    path: "/products/:id()",
    ...
    component: () => import("./_nuxt/_id_-D3x6cCdr.js").then((m) => m.default || m)
  },
  {
    name: "products",
    path: "/products",
    ...
    component: () => import("./_nuxt/index-D9exvbT5.js").then((m) => m.default || m)
  }
];
...
const layouts = {
  default: () => import("./_nuxt/default-CywrPIpO.js").then((m) => m.default || m)
};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import("./_nuxt/error-404-BktEi-vs.js").then((r) => r.default || r));
